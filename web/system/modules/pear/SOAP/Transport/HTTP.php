...
//			// scendix BEG
//			if( count($this->result_headers) == 0 || !isset($this->result_headers[0]) )
//			{
//				$code = 499;
//				$msg = "No headers returned by SOAP server. Payload = ".$this->incoming_payload;
//				log_debug("Weird HTTP headers: ",$this->result_headers);
//			}
//			else // scendix END
