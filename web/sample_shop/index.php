...
function ensure_db()
{
	...
	$ds->ExecuteSql("CREATE TABLE IF NOT EXISTS orders(id INTEGER,status INTEGER,created DATETIME,updated DATETIME,completed DATETIME,deleted DATETIME,price_total DOUBLE,$flds,PRIMARY KEY(id))");
