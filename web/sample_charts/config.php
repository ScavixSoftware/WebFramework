...
(
	...
	(
		'path' => __DIR__.'/../logs/',
		'filename_pattern' => 'chartroulette_wdf.log',
		'log_severity' => true,
	...
	(
		'class' => 'TraceLogger',
		'path' => __DIR__.'/../logs/',
		'filename_pattern' => 'chartroulette_wdf.trace',
		'log_severity' => true,
		'max_trace_depth' => 10,
		'max_filesize' => 10*1024*1024,
		'keep_for_days' => 4,
...
//$CONFIG['resources_system_url_root'] = 'http://chartroulette.if.it.is.free.com/'; // <- sample
